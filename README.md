...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=400&size=18&duration=2500&pause=1000&color=8B949E&center=true&vCenter=true&repeat=true&width=450&height=28&lines=Software+Engineer;Front-end+Developer;SQA+Engineer;Tech+Enthusiast;Content+Creator" alt="Roles" />
</p>
...
| **Blogging Website with Backend** | Complete blogging platform with MySQL backend, categorized posts, and user management. | PHP, MySQL, HTML, CSS | [Repo](https://github.com/nishatrhythm/Complete-Blogging-Website-with-Back-End) |

#### Mobile Applications

| Project | Description | Tech | Link |
|:---|:---|:---|:---:|
| **Quillium** | University-based social media app for students to connect, post, share stories, and message. | Android, Java, Firebase | [Repo](https://github.com/nishatrhythm/Quillium) |
| **CoinBank Wallet** | Personal finance tracker for daily/monthly income and expenses. | Android, Java, SQLite | [Repo](https://github.com/nishatrhythm/CoinBank-Wallet) |

#### AI / Machine Learning

| Project | Description | Tech | Link |
|:---|:---|:---|:---:|
| **Traffic Sign Recognition (CNN)** | CNN model classifying 43 traffic sign classes using GTSRB dataset. Includes web app, Android app, and webcam-based live testing. | Python, TensorFlow/Keras, OpenCV, Flask, Jetpack Compose | [Repo](https://github.com/nishatrhythm/Traffic-Signs-Classification-Using-Convolutional-Neural-Networks) |
| **CareerLink & TutorConnect** | AI-powered job recruitment platform with smart matching, plus a one-to-one learning platform connecting students with expert tutors. | Hackathon Project | [Repo](https://github.com/nishatrhythm/CareerLink-and-TutorConnect) |

#### UI/UX Design

| Project | Description | Link |
|:---|:---|:---:|
| **e-Desk** | Digital complaint, request, and suggestion platform with complete prototype and UI flow. | [Behance](https://www.behance.net/gallery/152540269/e-Desk) |
| **Campus Commune** | Hostel/mess finding platform for university students, especially useful for female students. | [Behance](https://www.behance.net/gallery/170866457/Campus-Commune) |
| **Highway Next** | Smart public transport management system with QR tracking and digital wallet. | [Behance](https://www.behance.net/gallery/152542393/Highway-Next-%28Public-Website%29) |

#### Templates & Tools

| Project | Description | Stars |
|:---|:---|:---:|
| [Responsive Animated Portfolio](https://github.com/nishatrhythm/Responsive-Animated-and-Colourful-Portfolio) | Animated portfolio website using HTML, CSS, JS | ![](https://img.shields.io/github/stars/nishatrhythm/Responsive-Animated-and-Colourful-Portfolio?style=flat&color=4A90D9) |
| [Premium Font Collection](https://github.com/nishatrhythm/Premium-Font-Collection) | Curated premium fonts from popular brands | ![](https://img.shields.io/github/stars/nishatrhythm/Premium-Font-Collection?style=flat&color=4A90D9) |
| [Student Intro Website Template](https://github.com/nishatrhythm/Students-Introductory-Website-Template) | Batch intro website template for university departments | ![](https://img.shields.io/github/stars/nishatrhythm/Students-Introductory-Website-Template?style=flat&color=4A90D9) |
| [Facebook Content Filter Extension](https://github.com/nishatrhythm/Facebook-Content-Filter-Extension) | Browser extension to filter distracting Facebook feed content | ![](https://img.shields.io/github/stars/nishatrhythm/Facebook-Content-Filter-Extension?style=flat&color=4A90D9) |
...
<p>
  ...
  <a href="https://drive.google.com/drive/u/2/folders/1FwU4_Jaezgl-CoDj9lV98_ld_Loxr9NB"><img src="https://img.shields.io/badge/All_Certificates-Google_Drive-4285F4?style=flat&logo=googledrive&logoColor=white" /></a>
</p>
...
| Project | Description | Stars |
|:---|:---|:---:|
| [SpotX](https://github.com/SpotX-Official/SpotX/commits?author=nishatrhythm) | SpotX patcher for the desktop version of Spotify | ![](https://img.shields.io/github/stars/SpotX-Official/SpotX?style=flat&color=4A90D9) |
...
<details>
<summary><b>Academic Repositories</b></summary>
<br/>

| Repository | Topic |
|:---|:---|
| [Machine Learning](https://github.com/nishatrhythm/Machine-Learning) | ML projects, model training, hyperparameter optimization |
| [Data Science](https://github.com/nishatrhythm/Data-Science-Lab) | Python, Pandas, NumPy, Matplotlib, Scikit-learn |
| [Data Mining & Warehousing](https://github.com/nishatrhythm/Data-Mining-and-Data-Warehousing-Lab) | Data preprocessing, modeling, encoding |
| [Cryptography & Info Security](https://github.com/nishatrhythm/Cryptography-and-Information-Security-Lab) | Classical and modern encryption algorithms |
| [Artificial Intelligence](https://github.com/nishatrhythm/Artificial-Intelligence-Lab) | Neural networks, Prolog, AI logic |
| [Computer Graphics & Animation](https://github.com/nishatrhythm/Computer-Graphics-and-Animation) | C++ and Python graphics programming |
| [Digital Signal Processing](https://github.com/nishatrhythm/Digital-Signal-Processing-Lab) | DSP exercises and implementations |
| [Compiler Design](https://github.com/nishatrhythm/Compiler-Design-and-Construction-Lab) | Lex, grammar parsing, C/C++ |
| [Operating Systems](https://github.com/nishatrhythm/Operating-Systems) | Shell scripting, UNIX commands |
| [Computer Architecture](https://github.com/nishatrhythm/Computer-Architecture-MIPS-Code) | MIPS code |
| [Database](https://github.com/nishatrhythm/Basic-Database) | MySQL fundamentals |
| [Numerical Analysis](https://github.com/nishatrhythm/Numerical-Analysis-Lab) | Numerical methods in Python |
| [Algorithms](https://github.com/nishatrhythm/Algorithm-Lab) | Algorithm implementations |
| [Digital Logic Design](https://github.com/nishatrhythm/Digital-Logic-Design-Lab) | Logisim circuits |
| [OOP (Java)](https://github.com/nishatrhythm/Object-Oriented-Programing-JAVA) | Object-oriented programming |
| [OOP (C++)](https://github.com/nishatrhythm/Object-Oriented-Programming-C-Plus-Plus) | Object-oriented programming |
| [Data Structures](https://github.com/nishatrhythm/Data-Structure-Lab) | Core data structures |
| [C / C++](https://github.com/nishatrhythm/Simple-C-and-C-Plus-PLus-Program) | Introductory programs |
...
<p align="center">
  ...
  <sub>Open to collaborations, freelance work, and new opportunities.</sub>
</p>
<p align="center">
